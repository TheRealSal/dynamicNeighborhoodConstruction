...
#SBATCH --mem=2G
#SBATCH --output=/scratch/%u/ift6162-project/heterogeneous_demand/dnc_O75/slurm_%A_%a.out
#SBATCH --error=/scratch/%u/ift6162-project/heterogeneous_demand/dnc_O75/slurm_%A_%a.err
#SBATCH --array=0-11
