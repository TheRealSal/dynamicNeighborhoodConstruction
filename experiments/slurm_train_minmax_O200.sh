#!/bin/bash
#SBATCH --job-name=minmax_O200
#SBATCH --account=def-account-name  # Replace with your Compute Canada account
#SBATCH --time=14:00:00
#SBATCH --cpus-per-task=56
#SBATCH --mem=64G
#SBATCH --output=/scratch/$USER/ift6162-project/minmax_O200/slurm_%j.out
#SBATCH --error=/scratch/$USER/ift6162-project/minmax_O200/slurm_%j.err
